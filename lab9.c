...
NODE readpoly()
{
	...
	do
	{
		...
		cur->link=temp;
		temp->link=head;
		printf("\nDo you want to enter more term(y/n)");
		scanf("%s",ch);
	}while(ch[0]=='y'||ch[0]=='Y');
	return head;
}
...
void main()
{
	...
	while(1)
	{
		...
		printf("4:Display the ploynomial B\n");
		printf("5:ADD A and B polynomial\n");
		...
		switch(ch)
		{
			case 1:printf("Enter the elements of polynomial A\n");
				 a=readpoly();
				 break;
			case 2:printf("Enter the elements of the polynomial B\n");
				 b=readpoly();
				 break;
			case 3:print(a);
				 break;
